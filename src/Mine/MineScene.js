...
import { Heading2, Heading3, Paragraph } from '../common/Text'
...
class MineScene extends PureComponent<Props, State> {
      ...
      <View style={styles.header}>
        ...
        <View>
          <View style={{ flexDirection: 'row', alignItems: 'center', }}>
            <Heading2 style={{ color: 'white' }}>孙有为</Heading2>
  ...
  render() {
    return (
      <View style={{ flex: 1, backgroundColor: color.paper }}>
        <View style={{ position: 'absolute', width: screen.width, height: screen.height , backgroundColor: color.primary }} />
        <ScrollView
          refreshControl={
            <RefreshControl
  ...
  getDataList() {
    return (
      [
        [
          { title: '我的钱包', subtitle: '招行办卡享折扣', image: require('../img/mine/icon_mine_wallet.png') },
          { title: '余额', subtitle: '￥525614', image: require('../img/mine/icon_mine_balance.png') },
